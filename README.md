About pipreqsnb-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pipreqsnb-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14917&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pipreqsnb-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pipreqsnb` can be installed with `conda`:
...
```
mamba install pipreqsnb
```

It is possible to list all of the versions of `pipreqsnb` available on your platform with `conda`:
...
```
mamba search pipreqsnb --channel conda-forge
```
...
mamba repoquery search pipreqsnb --channel conda-forge

# List packages depending on `pipreqsnb`:
mamba repoquery whoneeds pipreqsnb --channel conda-forge

# List dependencies of `pipreqsnb`:
mamba repoquery depends pipreqsnb --channel conda-forge
```
